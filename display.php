...
<center><h2>Manage Sender Emails</h2></center>
<?php
include 'DBconn.php';
session_start();
...
while($res = mysqli_fetch_array($result)) 
 {         
   ...
   echo "<td><a href=\"edit.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to update?')\">Edit</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";   
