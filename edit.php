...
$email=$_POST['email'];
$query3=mysqli_query($link,"update Users set name='$name', password='$password',email='$email' where id='$id'");
if($query3)
{
  ...
  <div class="login">
      ...
      <form action="" method="post">
        ...
        <input type="text" name="name" placeholder="Username" required="required" class="input-txt" value="<?php echo $query2['name']; ?>" />
          ...
          <input type="email" name="email" placeholder="email" required="required" class="input-txt" value="<?php echo $query2['email']; ?>" /> 
