...
while($res = mysqli_fetch_array($result)) 
 {         
   ...
   echo "<td><a href=\"Campaignrecord.php?name=$res[name]\" onClick=\"\">Show Email Records</a> | <a href=\"deleterecord.php?name=$res[name]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> </td>";   
