...
$result = mysqli_query($link, "SELECT * FROM Contacts where batchname="."'".$bname."'");
...
while($res = mysqli_fetch_array($result)) 
 {         
   ...
   echo "<tr>";
   echo "<td>".$res['batchid']."</td>";
   echo "<td>".$res['batchname']."</td>";
   echo "<td>".$res['email']."</td>"; 
   echo "<td><a href=\"deletecontact.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete Contact</a> | <a href=\"deletebatch.php?batchid=$res[batchid]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete Batch</a></td>"; 
