...
<center><h2>Manage Batches</h2></center>
<?php
include 'DBconn.php';
session_start();
...
$result = mysqli_query($link, "SELECT * FROM CampaignTrack");
...
while($res = mysqli_fetch_array($result)) 
 {         
   ...
   echo "<td><a href=\"Showcampaign.php?name=$res[name]\" onClick=\"\">Show Campaign File</a> | <a href=\"deletecampaign.php?name=$res[name]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";   
