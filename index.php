...
<center> <div class="container">
  <div class="login">
    <h1 class="login-heading">-Please Fill Records-</h1><br>
      <form action="Connection.php" method="post">
        <input type="text" name="name" placeholder="Enter Name" required="required" class="input-txt" />
          <input type="password" name="password" placeholder="Password" required="required" class="input-txt" />
          <input type="email" name="email" placeholder="Enter Email" required="required" class="input-txt" /></td> 
