...
<h2><center>Check Replies</center></h2>
...
while($res = mysqli_fetch_array($result)) 
 {  
   ...
   echo "<td><a href=inboxdata.php?recieverid=".$res['email']."&recieverpss=".$res['password'].">See Replies</a></td>";
    }
